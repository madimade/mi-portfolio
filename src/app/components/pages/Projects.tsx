...
const projects = [
  ...
  },
  {
    ...
    description:
      "Modern analytics dashboard built with React, featuring real-time charts, data visualization, responsive design, and dark/light mode.",
    tech: ["React", "JavaScript", "CSS3"],
    category: "React",
    gradient: "135deg, #38bdf822, #00f5ff22",
  ...
  },
  {
    ...
    category: "React",
    gradient: "135deg, #00f5ff22, #a78bfa22",
    github: "https://game-verse0.netlify.app/",
    demo: "https://example.com",
    featured: false,
  },
];
